            ...
            <form className="form-validate">
                        ...
                        <div className="form-group ">
                          ...
                          <div className="form-control-wrap">
                            <input
                              ...
                              className="form-control"
                            />
                            {idx > 0 && idx < 5 ? <button className="btn" onClick={this.handleRemoveShareholder(idx)}><em className="icon ni ni-minus-c"></em><span>Remove address</span></button> : null}
              ...
              </div>
              {
                this.state.address.length < 5 ? <div className="row mt-2 ml-n4">
                  <div className="col-lg-4">
                    <button className="btn" onClick={this.handleAddShareholder}><em className="icon ni ni-plus-c"></em><span> Add Address line</span></button>
                  </div>
                </div> : null
              }
