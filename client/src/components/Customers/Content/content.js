    ...
    render(){
        return (
            <div class="nk-content ml-5">
                                                ...
                                                <div class="toggle-expand-content" data-content="more-options">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt">
                                                            ...
                                                            <button data-toggle="modal" data-target="#addmodal" class="toggle btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Customer</span></button>
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <ul class="link-list-opt no-bdr">
                                                                    ...
                                                                    <li><a href="#"><em class="icon ni ni-repeat"></em><span>Define Item Cost</span></a></li>
                                                                    <li class="divider"></li>
                    ...
                    {/* <!-- Modal Content Code - add customer --> */}  
                                ...
                                <div class="modal-body">
                                    <div class="nk-block">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-mb-8">
                                                <div class="form-group">
                                                    <label class="form-label" for="limit">Customer Limit</label>
                                                    <div class="form-control-wrap">
                                            ...
                                            <div>
                                                <div>
                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" id="flatrate"/>
                                                        <label class="custom-control-label" for="flatrate">Apply Flat Rate</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
